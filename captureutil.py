...
def login(driver, username, password):
  ...
  #driver.find_element(By.XPATH, "//[@id='email-signin__user-name-input__4fb58384-312f-41b6-8b1a-2ea6a70f93e1']").send_keys(username)
  #driver.find_element(By.XPATH, "//[@id='email-signin__password-input__4fb58384-312f-41b6-8b1a-2ea6a70f93e1']").send_keys(password)
